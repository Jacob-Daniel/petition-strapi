...
export interface ApiBasketBasket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    basketState: Schema.Attribute.Enumeration<
      ['active', 'booking', 'paid', 'archived']
    > &
...
export interface ApiEmailSettingEmailSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    email_footer: Schema.Attribute.Blocks;
    email_sender_name: Schema.Attribute.String;
    ...
    SMTP_PASS: Schema.Attribute.String;
    SMTP_PORT: Schema.Attribute.String;
    SMTP_SECURITY_TYPE: Schema.Attribute.Enumeration<['None', 'SSL', 'TLS']>;
    SMTP_USER: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event.event'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.Relation<'manyToOne', 'api::place.place'>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    column_four: Schema.Attribute.DynamicZone<
      ['content.heading', 'layout.social-platforms']
    >;
    column_one: Schema.Attribute.DynamicZone<
      ['content.heading', 'layout.place', 'layout.navigation']
    >;
    column_three: Schema.Attribute.DynamicZone<
      ['content.heading', 'layout.navigation']
    >;
    column_two: Schema.Attribute.DynamicZone<
      ['content.heading', 'layout.place']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    footer_end: Schema.Attribute.DynamicZone<
      ['organisation.certification-logos']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNavigationItemNavigationItem
  ...
  attributes: {
    ...
    is_button: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiOrganisationOrganisation
  ...
  info: {
    description: 'Groups that manage or participate in garden life';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    external_website_url: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    manages_places: Schema.Attribute.Relation<'oneToMany', 'api::place.place'>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    social_media: Schema.Attribute.Component<
      'organisation.social-platforms',
      false
    >;
    summary: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        'content.gallery',
        'content.content',
        'layout.organisation-section',
        'form.form-section',
        'layout.calendar',
        'layout.places-section',
        'layout.mixed-content-tab-section',
        'layout.info-tab-section',
        'layout.featured',
        'layout.comment-section',
        'layout.petition-section',
        'organisation.social-platforms',
...
export interface ApiPlacePlace extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Physical locations in the Community Garden';
    displayName: 'Places';
    pluralName: 'places';
    singularName: 'place';
  };
  ...
  attributes: {
    ...
    calendar_enabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::place.place'> &
      Schema.Attribute.Private;
    managing_organisation: Schema.Attribute.Relation<
      'manyToOne',
      'api::organisation.organisation'
    >;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiSignatureSignature extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    anonymize: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    petitionLimit: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTabTab extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tab.tab'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    tabs: Schema.Attribute.DynamicZone<['layout.info-tabs', 'content.gallery']>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    baskets: Schema.Attribute.Relation<'oneToMany', 'api::basket.basket'>;
